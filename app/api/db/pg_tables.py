...
companies = Table(
    ...
    Column('ipo', DateTime, nullable=True),
...
dividends = Table(
    ...
    Column('date', DateTime, nullable=True),
    Column('declaration_date', DateTime, nullable=True),
    Column('pay_date', DateTime, nullable=True),
    Column('record_date', DateTime, nullable=True),
